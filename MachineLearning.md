...
- [ Google's teachable machine](https://teachablemachine.withgoogle.com/): Google's teachable machine is really nice way to train a machine and to know how machine learning actually works!
